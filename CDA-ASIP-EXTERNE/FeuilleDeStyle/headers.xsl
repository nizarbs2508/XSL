...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  xmlns:ps3-20="urn:dicom-org:ps3-20" xmlns:n1="urn:hl7-org:v3"
  ...
  <xsl:template name="documentGeneral"> Document <table class="header_table">
      <tbody>
        ...
        <xsl:if test="n1:relatedDocument">
          <xsl:if test="n1:relatedDocument/n1:parentDocument/n1:id/@root">
            <tr>
              <td width="20%">
                <xsl:if test="n1:relatedDocument[@typeCode = 'RPLC']/n1:parentDocument/n1:id">
                  <span class="td_label">
                    <xsl:text>Document remplacé</xsl:text>
                  </span>
                  <br/>
                </xsl:if>
                <xsl:if test="n1:relatedDocument[@typeCode = 'XFRM']/n1:parentDocument/n1:id">
                  <span class="td_label">
              ...
              <td width="80%">
                <xsl:for-each select="n1:relatedDocument/n1:parentDocument/n1:id">
                  <xsl:call-template name="show-id"/>
                </xsl:for-each>
              </td>
            </tr>
            <!-- <xsl:for-each select="n1:relatedDocument/n1:parentDocument/n1:versionNumber">
              <tr>
                <td width="20%">
                  <span class="td_label">
                    <xsl:text>Version</xsl:text>
                ...
                <xsl:if test="n1:assignedAuthor/n1:assignedPerson">
                  <details>
                      ...
                      <xsl:if test="n1:assignedAuthor/n1:assignedPerson/n1:name">
                        <xsl:call-template name="show-name">
                          ...
                          <xsl:with-param name="suffix"
                            select="n1:assignedAuthor/n1:assignedPerson/n1:name/n1:suffix"/>
                          <xsl:with-param name="prefix"
                            select="n1:assignedAuthor/n1:assignedPerson/n1:name/n1:prefix"/>
                          <xsl:with-param name="given"
                            select="n1:assignedAuthor/n1:assignedPerson/n1:name/n1:given"/>
                          <xsl:with-param name="family"
                            select="n1:assignedAuthor/n1:assignedPerson/n1:name/n1:family"/>
                        </xsl:call-template>
                      </xsl:if>
                    </summary>
                    ...
                    <xsl:if test="n1:assignedAuthor/n1:assignedAuthoringDevice/n1:softwareName">
                      <br/>
                      <xsl:value-of
                        select="n1:assignedAuthor/n1:assignedAuthoringDevice/n1:softwareName"/>
                    </xsl:if>
                    <!-- Adresse de l'auteur -->
                    ...
                    <details>
                      <summary>
                        <xsl:if test="n1:assignedAuthor/n1:representedOrganization/n1:name">
                          <xsl:call-template name="show-name">
                            <xsl:with-param name="name"
                              select="n1:assignedAuthor/n1:representedOrganization/n1:name"/>
                          </xsl:call-template>
                        </xsl:if>
                      </summary>
                        ...
                        <xsl:for-each select="n1:assignedAuthor/n1:representedOrganization/n1:id">
                          <xsl:call-template name="show-id">
                            <xsl:with-param name="id"
                              select="n1:assignedAuthor/n1:representedOrganization/n1:id"/>
                          </xsl:call-template>
                        </xsl:for-each>
                      </xsl:if>
                      ...
                      <xsl:if test="n1:assignedAuthor/n1:representedOrganization/n1:telecom">
                        <br/>
                        <xsl:for-each
                          select="n1:assignedAuthor/n1:representedOrganization/n1:telecom">
                          <xsl:call-template name="show-telecom">
                            <xsl:with-param name="telecom" select="."/>
                          </xsl:call-template>
                        </xsl:for-each>
              ...
              <tr>
                ...
                <td>
                  <xsl:call-template name="show-participantOriginalText">
                    <xsl:with-param name="participantOriginalText"
                      select="n1:functionCode/n1:originalText"/>
                  </xsl:call-template>
                </td>
              </tr>
            </xsl:if>
                    ...
                    <summary>
                      <xsl:if test="n1:assignedEntity/n1:assignedPerson/n1:name">
                        <xsl:call-template name="show-name">
                          ...
                          <xsl:with-param name="suffix"
                            select="n1:assignedEntity/n1:assignedPerson/n1:name/n1:suffix"/>
                          <xsl:with-param name="prefix"
                            select="n1:assignedEntity/n1:assignedPerson/n1:name/n1:prefix"/>
                          <xsl:with-param name="given"
                            select="n1:assignedEntity/n1:assignedPerson/n1:name/n1:given"/>
                          <xsl:with-param name="family"
                            select="n1:assignedEntity/n1:assignedPerson/n1:name/n1:family"/>
                        </xsl:call-template>
                      </xsl:if>
                    </summary>
                ...
                <xsl:if test="n1:assignedEntity/n1:representedOrganization">
                  <details>
                    ...
                    <xsl:if test="n1:assignedEntity/n1:representedOrganization/n1:addr">
                      <br/>
                      <xsl:for-each select="n1:assignedEntity/n1:representedOrganization/n1:addr">
                        <xsl:call-template name="show-address">
                          <xsl:with-param name="address" select="."/>
                        </xsl:call-template>
                        <br/>
              ...
              <xsl:if test="n1:legalAuthenticator/n1:assignedEntity">
                <details>
                  <summary>
                    ...
                    <xsl:call-template name="show-name">
                      <xsl:with-param name="name"
                        select="n1:legalAuthenticator/n1:assignedEntity/n1:assignedPerson/n1:name"/>
                      <xsl:with-param name="suffix"
                        select="n1:legalAuthenticator/n1:assignedEntity/n1:assignedPerson/n1:name/n1:suffix"/>
                      <xsl:with-param name="prefix"
                        select="n1:legalAuthenticator/n1:assignedEntity/n1:assignedPerson/n1:name/n1:prefix"/>
                      <xsl:with-param name="given"
                        select="n1:legalAuthenticator/n1:assignedEntity/n1:assignedPerson/n1:name/n1:given"/>
                      <xsl:with-param name="family"
                        select="n1:legalAuthenticator/n1:assignedEntity/n1:assignedPerson/n1:name/n1:family"
                      />
                    </xsl:call-template>
                  </summary>
                  <xsl:if test="n1:legalAuthenticator/n1:assignedEntity/n1:id">
                    <xsl:for-each select="n1:legalAuthenticator/n1:assignedEntity/n1:id">
                      <xsl:call-template name="show-id">
                        <xsl:with-param name="id"
                          select="n1:legalAuthenticator/n1:assignedEntity/n1:id"/>
                      </xsl:call-template>
                    </xsl:for-each>
                  </xsl:if>
                  <br/>
                  ...
                  <xsl:if test="n1:legalAuthenticator/n1:assignedEntity/n1:addr">
                    <br/>
                    <xsl:for-each select="n1:legalAuthenticator/n1:assignedEntity/n1:addr">
                      <xsl:call-template name="show-address">
                        <xsl:with-param name="address" select="."/>
                      </xsl:call-template>
                      <br/>
                ...
                <details>
                  <summary>
                    <xsl:if test="n1:dataEnterer/n1:assignedEntity/n1:assignedPerson/n1:name">
                      <xsl:call-template name="show-name">
                        <xsl:with-param name="name"
                          select="n1:dataEnterer/n1:assignedEntity/n1:assignedPerson/n1:name"/>
                        <xsl:with-param name="suffix"
                          select="n1:dataEnterer/n1:assignedEntity/n1:assignedPerson/n1:name/n1:suffix"/>
                        <xsl:with-param name="prefix"
                          select="n1:dataEnterer/n1:assignedEntity/n1:assignedPerson/n1:name/n1:prefix"/>
                        <xsl:with-param name="given"
                          select="n1:dataEnterer/n1:assignedEntity/n1:assignedPerson/n1:name/n1:given"/>
                        <xsl:with-param name="family"
                          select="n1:dataEnterer/n1:assignedEntity/n1:assignedPerson/n1:name/n1:family"
                        />
                      </xsl:call-template>
                    </xsl:if>
                  </summary>
                  ...
                  <xsl:if test="n1:dataEnterer/n1:assignedEntity/n1:addr">
                    <br/>
                    <xsl:for-each select="n1:dataEnterer/n1:assignedEntity/n1:addr">
                      <xsl:call-template name="show-address">
                        <xsl:with-param name="address" select="."/>
                      </xsl:call-template>
                      <br/>
              ...
              <td width="80%" colspan="3">
                <xsl:if test="n1:dataEnterer/n1:assignedEntity/n1:representedOrganization">
                  <details>
                    ...
                    <xsl:if
                      test="n1:dataEnterer/n1:assignedEntity/n1:representedOrganization/n1:addr">
                      <br/>
                      <xsl:for-each
  ...
  <xsl:template name="componentof">
    <xsl:if test="n1:componentOf"> Prise en charge <table class="header_table">
        <tbody>
          ...
          <xsl:if test="n1:componentOf/n1:encompassingEncounter/n1:responsibleParty">
            <tr>
              ...
              <td width="80%" colspan="3">
                ...
                <xsl:if
                  test="n1:componentOf/n1:encompassingEncounter/n1:responsibleParty/n1:assignedEntity">
                  <details>
                    <summary>
                      <xsl:call-template name="show-name">
                        <xsl:with-param name="name"
                          select="n1:componentOf/n1:encompassingEncounter/n1:responsibleParty/n1:assignedEntity/n1:assignedPerson/n1:name"/>
                        <xsl:with-param name="suffix"
                          select="n1:componentOf/n1:encompassingEncounter/n1:responsibleParty/n1:assignedEntity/n1:assignedPerson/n1:name/n1:suffix"/>
                        <xsl:with-param name="prefix"
                          select="n1:componentOf/n1:encompassingEncounter/n1:responsibleParty/n1:assignedEntity/n1:assignedPerson/n1:name/n1:prefix"/>
                        <xsl:with-param name="given"
                          select="n1:componentOf/n1:encompassingEncounter/n1:responsibleParty/n1:assignedEntity/n1:assignedPerson/n1:name/n1:given"/>
                        <xsl:with-param name="family"
                          select="n1:componentOf/n1:encompassingEncounter/n1:responsibleParty/n1:assignedEntity/n1:assignedPerson/n1:name/n1:family"
                        />
                      </xsl:call-template>
                    </summary>
                    <xsl:if
                      test="n1:componentOf/n1:encompassingEncounter/n1:responsibleParty/n1:assignedEntity/n1:id">
                      <xsl:for-each
                        select="n1:componentOf/n1:encompassingEncounter/n1:responsibleParty/n1:assignedEntity/n1:id">
                        <xsl:call-template name="show-id">
                          <xsl:with-param name="id"
                            select="n1:componentOf/n1:encompassingEncounter/n1:responsibleParty/n1:assignedEntity/n1:id"
                          />
                    ...
                    <xsl:if
                      test="n1:componentOf/n1:encompassingEncounter/n1:responsibleParty/n1:assignedEntity/n1:addr">
                      <br/>
                      <xsl:for-each
                    ...
                    <xsl:if
                      test="n1:componentOf/n1:encompassingEncounter/n1:responsibleParty/n1:assignedEntity/n1:telecom">
                      <br/>
                      <xsl:for-each
                        select="n1:componentOf/n1:encompassingEncounter/n1:responsibleParty/n1:assignedEntity/n1:telecom">
                        <xsl:call-template name="show-telecom">
                          <xsl:with-param name="telecom" select="."/>
                        </xsl:call-template>
                      </xsl:for-each>
            ...
            <xsl:if
              test="n1:componentOf/n1:encompassingEncounter/n1:responsibleParty/n1:assignedEntity/n1:representedOrganization">
              <tr>
                <td width="20%">
                  <span class="td_label">
                    <xsl:text>Organisation</xsl:text>
                ...
                <td width="80%" colspan="3">
                  <xsl:if
                    ...
                    <details>
                      ...
                      <xsl:if
                        test="n1:componentOf/n1:encompassingEncounter/n1:responsibleParty/n1:assignedEntity/n1:representedOrganization/n1:addr">
                        <br/>
                        <xsl:for-each
                      ...
                      <!-- Télécom organisation du signataire légal -->
                      <xsl:if
                        test="n1:componentOf/n1:encompassingEncounter/n1:responsibleParty/n1:assignedEntity/n1:representedOrganization/n1:telecom">
                        <br/>
                        <xsl:for-each
                          select="n1:componentOf/n1:encompassingEncounter/n1:responsibleParty/n1:assignedEntity/n1:representedOrganization/n1:telecom">
                          <xsl:call-template name="show-telecom">
                            <xsl:with-param name="telecom" select="."/>
                          </xsl:call-template>
                        </xsl:for-each>
          ...
          <xsl:if test="n1:componentOf/n1:encompassingEncounter/n1:location/n1:healthCareFacility">
            <tr>
              <td width="20%">
                <span class="td_label">
                    ...
                    <summary>
                      <xsl:if
                        ...
                        <xsl:call-template name="show-name">
                          ...
                          <xsl:with-param name="suffix"
                            select="n1:componentOf/n1:encompassingEncounter/n1:location/n1:healthCareFacility/n1:location/n1:name/n1:suffix"/>
                          <xsl:with-param name="prefix"
                            select="n1:componentOf/n1:encompassingEncounter/n1:location/n1:healthCareFacility/n1:location/n1:name/n1:prefix"/>
                          <xsl:with-param name="given"
                            select="n1:componentOf/n1:encompassingEncounter/n1:location/n1:healthCareFacility/n1:location/n1:name/n1:given"/>
                          <xsl:with-param name="family"
                            select="n1:componentOf/n1:encompassingEncounter/n1:location/n1:healthCareFacility/n1:location/n1:name/n1:family"
                          />
                        </xsl:call-template>
                      </xsl:if>
                    </summary>
                  ...
                  <summary>
                    <xsl:if
                      ...
                      <xsl:call-template name="show-name">
                        ...
                        <xsl:with-param name="suffix"
                          select="n1:custodian/n1:assignedCustodian/n1:representedCustodianOrganization/n1:name/n1:suffix"/>
                        <xsl:with-param name="prefix"
                          select="n1:custodian/n1:assignedCustodian/n1:representedCustodianOrganization/n1:name/n1:prefix"/>
                        <xsl:with-param name="given"
                          select="n1:custodian/n1:assignedCustodian/n1:representedCustodianOrganization/n1:name/n1:given"/>
                        <xsl:with-param name="family"
                          select="n1:custodian/n1:assignedCustodian/n1:representedCustodianOrganization/n1:name/n1:family"
                        />
                      </xsl:call-template>
                    </xsl:if>
                  </summary>
                    ...
                    <summary>
                      <xsl:if test="n1:intendedRecipient/n1:informationRecipient/n1:name">
                        <xsl:call-template name="show-name">
                          ...
                          <xsl:with-param name="suffix"
                            select="n1:intendedRecipient/n1:informationRecipient/n1:name/n1:suffix"/>
                          <xsl:with-param name="prefix"
                            select="n1:intendedRecipient/n1:informationRecipient/n1:name/n1:prefix"/>
                          <xsl:with-param name="given"
                            select="n1:intendedRecipient/n1:informationRecipient/n1:name/n1:given"/>
                          <xsl:with-param name="family"
                            select="n1:intendedRecipient/n1:informationRecipient/n1:name/n1:family"
                          />
                        </xsl:call-template>
                      </xsl:if>
                    </summary>
                  ...
                  <xsl:if test="n1:intendedRecipient/n1:receivedOrganization">
                    <details>
                      ...
                      <xsl:if test="n1:intendedRecipient/n1:receivedOrganization/n1:addr">
                        <br/>
                        <xsl:for-each select="n1:intendedRecipient/n1:receivedOrganization/n1:addr">
                          <xsl:call-template name="show-address">
                            <xsl:with-param name="address" select="."/>
                          </xsl:call-template>
                          <br/>
                      ...
                      <xsl:if test="n1:intendedRecipient/n1:receivedOrganization/n1:telecom">
                        <br/>
                        <xsl:for-each
                          select="n1:intendedRecipient/n1:receivedOrganization/n1:telecom">
                          <xsl:call-template name="show-telecom">
                            <xsl:with-param name="telecom" select="."/>
                          </xsl:call-template>
                        </xsl:for-each>
  ...
  <xsl:template name="participant">
    ...
    <xsl:if test="n1:participant">Participant(s) <details>
                        ...
                        <xsl:choose>
                          ...
                          <xsl:when test="@typeCode = 'REF'">
                            ...
                            <xsl:if test="not(n1:functionCode)">
                              <xsl:text>Référent/Prescripteur</xsl:text>
                            </xsl:if>
                          </xsl:when>
                          <xsl:when test="@typeCode = 'REFB'">
                            <xsl:text>Personne ayant adressé le patient</xsl:text>
                          </xsl:when>
                            ...
                            <xsl:if test="n1:functionCode">
                              <xsl:choose>
                                <xsl:when test="n1:functionCode/@code = 'ATTPHYS'">
                                  <xsl:text>Référent - Responsable du patient dans la structure de soins</xsl:text>
                                </xsl:when>
                                <xsl:when test="n1:functionCode/@code = '353'">
                    ...
                    <details>
                      <summary>
                        <xsl:call-template name="show-name">
                          ...
                          <xsl:with-param name="suffix"
                            select="n1:associatedEntity/n1:associatedPerson/n1:name/n1:suffix"/>
                          <xsl:with-param name="prefix"
                            select="n1:associatedEntity/n1:associatedPerson/n1:name/n1:prefix"/>
                          <xsl:with-param name="given"
                            select="n1:associatedEntity/n1:associatedPerson/n1:name/n1:given"/>
                          <xsl:with-param name="family"
                            select="n1:associatedEntity/n1:associatedPerson/n1:name/n1:family"/>
                        </xsl:call-template>
                      </summary>
                    ...
                    <details>
                      ...
                      <xsl:if test="n1:associatedEntity/n1:scopingOrganization/n1:id">
                        <xsl:for-each select="n1:associatedEntity/n1:scopingOrganization/n1:id">
                          <xsl:call-template name="show-id">
                            <xsl:with-param name="id"
                              select="n1:associatedEntity/n1:scopingOrganization/n1:id"/>
                          </xsl:call-template>
                        </xsl:for-each>
                      </xsl:if>
                      <br/>
                      ...
                      <xsl:if test="n1:associatedEntity/n1:scopingOrganization/n1:addr">
                        <xsl:for-each select="n1:associatedEntity/n1:scopingOrganization/n1:addr">
                          <xsl:call-template name="show-address">
                            <xsl:with-param name="address" select="."/>
                          </xsl:call-template>
                        </xsl:for-each>
      ...
      <tbody>
        <xsl:for-each select="n1:recordTarget/n1:patientRole">
          <xsl:if test="not(n1:id/@nullFlavor)">
            ...
            <xsl:if test="n1:patient/n1:birthTime">
              <tr>
                <td width="20%">
                  <span class="td_label">
            ...
            <xsl:if test="n1:patient/n1:administrativeGenderCode">
              <tr>
                <td width="15%">
                  <span class="td_label">
                ...
                <td colspan="3">
                  <xsl:if test="n1:patient/n1:birthplace/n1:place/n1:name">
                    <xsl:call-template name="show-name">
                      ...
                      <xsl:with-param name="suffix"
                        select="n1:patient/n1:birthplace/n1:place/n1:name/n1:suffix"/>
                      <xsl:with-param name="prefix"
                        select="n1:patient/n1:birthplace/n1:place/n1:name/n1:prefix"/>
                      <xsl:with-param name="given"
                        select="n1:patient/n1:birthplace/n1:place/n1:name/n1:given"/>
                      <xsl:with-param name="family"
                        select="n1:patient/n1:birthplace/n1:place/n1:name/n1:family"/>
                    </xsl:call-template>
                    <br/>
                  </xsl:if>
            ...
            <xsl:if
              test="n1:id/@root = '1.2.250.1.213.1.4.8' or n1:id/@root = '1.2.250.1.213.1.4.9' or n1:id/@root = '1.2.250.1.213.1.4.10' or n1:id/@root = '1.2.250.1.213.1.4.11'">
              <tr>
                <td>
                  <span class="td_label">
            ...
            <xsl:if
              test="n1:id/@root != '1.2.250.1.213.1.4.8' and n1:id/@root != '1.2.250.1.213.1.4.9' and n1:id/@root != '1.2.250.1.213.1.4.10' and n1:id/@root != '1.2.250.1.213.1.4.11'">
              <tr>
                <td>
                  <span class="td_label">
