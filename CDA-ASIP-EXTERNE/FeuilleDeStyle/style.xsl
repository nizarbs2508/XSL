          ...
          <xsl:choose>
            <xsl:when test="n1:assignedPerson/n1:name">
              <xsl:call-template name="show-name">
                ...
                <xsl:with-param name="suffix" select="n1:assignedPerson/n1:name/n1:suffix"/>
                <xsl:with-param name="prefix" select="n1:assignedPerson/n1:name/n1:prefix"/>
                <xsl:with-param name="given" select="n1:assignedPerson/n1:name/n1:given"/>
                <xsl:with-param name="family" select="n1:assignedPerson/n1:name/n1:family"/>
              </xsl:call-template>
